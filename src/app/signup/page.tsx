    ...
    <main className="min-h-screen flex relative overflow-hidden">
      ...
      <div className="hidden md:block md:w-1/2 relative">
        ...
        >
          ...
          <p className="font-display text-2xl text-white font-bold">Start your culinary journey</p>
        </motion.div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 md:px-16 py-8 sm:py-12 relative">
        ...
        >
          ...
          >
            <p className="font-mono text-xs uppercase tracking-[0.2em] text-muted mb-2">Get started</p>
            <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold mb-8 sm:mb-10">
              Create <span className="text-accent glow-signal">Account</span>
            </h1>
          </motion.div>
